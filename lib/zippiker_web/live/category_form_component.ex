defmodule ZippikerWeb.CategoryFormComponent do
  ...
  ### Example:
      - <ZippikerWeb.Categories.CategoryForm.form /> for creating a new category
      - <ZippikerWeb.Categories.CategoryForm.form category_id={...}/> for editing an existing category


  ### Params
    id: unique string identifier for this components. It allows us to have this component multiple times on the same page.
        default: UUIDv7
